...
class MutableQuad {
    ...
    MutableQuad(int tintIndex, EnumFacing face) {
        this(tintIndex, face, false);
    }

    MutableQuad(int tintIndex, EnumFacing face, boolean shade) {
    ...
    MutableQuad setFace(EnumFacing face) {
        this.face = face;
        return this;
    }
    ...
    /** Sets the normal for all vertices to the specified {@link com.thesledgehammer.groovymc.utils.VecDouble}, using
     * {@link com.thesledgehammer.groovymc.utils.VecDouble#a},{@link com.thesledgehammer.groovymc.utils.VecDouble#b}, and {@link com.thesledgehammer.groovymc.utils.VecDouble#c} */
    ...
    MutableQuad rotate(EnumFacing from, EnumFacing to, float ox, float oy, float oz) {
        if (from == to) {
